...
module RbConfig
  ...
  CONFIG["TEENY"] = "1"
  CONFIG["PATCHLEVEL"] = "0"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "D:/ruby34-install")
  CONFIG["EXEEXT"] = ".exe"
  ...
  CONFIG["CFLAGS"] = "-MD -Zi -W2 -wd4100 -wd4127 -wd4210 -wd4214 -wd4255 -wd4574  -wd4668 -wd4710 -wd4711 -wd4820 -wd4996  -we4028 -we4142 -we4047 -we4013 -O2sy- -Zc:inline -Zm600 "
  CONFIG["WERRORFLAG"] = "-WX"
  CONFIG["DEFS"] = ""
  CONFIG["CPPFLAGS"] = " -D_WIN32_WINNT=_WIN32_WINNT_WIN8  "
  CONFIG["CXXFLAGS"] = "-MD -Zi -W2 -wd4100 -wd4127 -wd4210 -wd4214 -wd4255 -wd4574  -wd4668 -wd4710 -wd4711 -wd4820 -wd4996  -we4028 -we4142 -we4047 -we4013 -O2sy- -Zc:inline -Zm600 "
  CONFIG["incflags"] = ""
  CONFIG["FFLAGS"] = ""
  ...
  CONFIG["CXX"] = "$(CC)"
  CONFIG["LD"] = "$(CC)"
  CONFIG["YACC"] = "C:\\RUBY33~1\\bin\\ruby.exe D:/ruby34-mswin/tool/lrama/exe/lrama"
  CONFIG["RANLIB"] = ""
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --prefix=D:/ruby34-install --disable-install-doc"
