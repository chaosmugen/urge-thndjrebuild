...
module RbConfig
  ...
  CONFIG["TEENY"] = "6"
  CONFIG["PATCHLEVEL"] = "0"
  CONFIG["INSTALL"] = '/d/msys64/usr/bin/install -c'
  CONFIG["EXEEXT"] = ".exe"
  ...
  CONFIG["configure_args"] = " '--host=x86_64-w64-mingw32' '--prefix=D:/ruby-build/ruby40-ucrt-install' '--disable-install-doc' '--disable-install-rdoc' '--with-baseruby=C:/Ruby40-x64/bin/ruby.exe' '--enable-yjit' 'CFLAGS=-O2 -g' 'host_alias=x86_64-w64-mingw32'"
  ...
  CONFIG["MAINLIBS"] = "-lgmp -lshell32 -lws2_32 -liphlpapi -limagehlp -lshlwapi -lbcrypt -lntdll -luserenv -ladvapi32 "
  ...
  CONFIG["RLIB_DIR"] = ""
  CONFIG["RUST_LIB"] = "/d/ruby-build/ruby40-ucrt/$(YJIT_LIBS)"
  CONFIG["JIT_OBJ"] = "jit.$(OBJEXT)"
  CONFIG["ZJIT_OBJ"] = ""
  CONFIG["ZJIT_LIBS"] = ""
  CONFIG["ZJIT_SUPPORT"] = "no"
  CONFIG["YJIT_OBJ"] = "yjit.$(OBJEXT)"
  CONFIG["YJIT_LIBS"] = "target/release/libyjit.a"
  ...
  CONFIG["ALLOCA"] = ""
  CONFIG["EGREP"] = "/d/msys64/usr/bin/grep -E"
  CONFIG["GREP"] = "/d/msys64/usr/bin/grep"
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["DOXYGEN"] = ""
  CONFIG["DOT"] = ""
  CONFIG["MKDIR_P"] = "/d/msys64/usr/bin/mkdir -p"
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "x86_64-w64-mingw32-cc.exe (Rev3, Built by MSYS2 project) 16.2.0\nCopyright (C) 2026 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["NM"] = "nm"
  CONFIG["LD"] = "ld"
  CONFIG["CXX"] = "x86_64-w64-mingw32-g++ -std=gnu++11"
  CONFIG["AS"] = "as"
  CONFIG["AR"] = "ar"
  CONFIG["CC"] = "x86_64-w64-mingw32-cc"
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
  ...
  CONFIG["MAKEDIRS"] = "/d/msys64/usr/bin/mkdir -p"
  CONFIG["target_alias"] = ""
