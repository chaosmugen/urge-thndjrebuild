...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/4.0.0/x64-mswin64_140")
  ...
  CONFIG["TEENY"] = "6"
  CONFIG["PATCHLEVEL"] = "0"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "D:\\ruby-build\\ruby40-install")
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "x64-vcruntime140-ruby400"
  ...
  CONFIG["CC"] = "cl -nologo -source-charset:utf-8"
  CONFIG["CPP"] = "cl -nologo -source-charset:utf-8 -E"
  CONFIG["CXX"] = "$(CC)"
  CONFIG["LD"] = "$(CC)"
  CONFIG["LRAMA"] = "C:\\Ruby34-x64\\bin\\ruby.exe ./tool/lrama/exe/lrama"
  CONFIG["RANLIB"] = ""
  ...
  CONFIG["RMDIRS"] = "$(COMSPEC) /C $(top_srcdir:/=\\)\\win32\\rmdirs.bat -p"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["CCDLFLAGS"] = ""
  CONFIG["LDSHARED"] = "cl -nologo -source-charset:utf-8 -LD"
  CONFIG["SOEXT"] = "dll"
  CONFIG["DLEXT"] = "so"
  CONFIG["LIBEXT"] = "lib"
  CONFIG["STRIP"] = ""
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --prefix=D:\\ruby-build\\ruby40-install --disable-install-doc --with-baseruby=C:\\Ruby34-x64\\bin\\ruby.exe"
