...
ext_build_dir = .bundle/gems/bigdecimal-4.0.1

ruby = $(topdir)/miniruby.exe -I'$(topdir)' -I'$(top_srcdir)/lib' \
       -I'$(extout)/$(arch)' -I'$(extout)/common'
RUBY = $(ruby)
extensions = .bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/.
EXTOBJS = dmyext.o
EXTLIBS =
EXTSO =
...
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/all:
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/install:
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/static:
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/install-so:
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/install-rb:
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/clean: clean-local
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/distclean: clean-local
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
	$(Q)$(RM) $(ext_build_dir)/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/bigdecimal-4.0.1/ext/bigdecimal/realclean: clean-local
	$(Q)$(MAKE) -C $(@D) $(MFLAGS) V=$(V) $(@F)
	$(Q)$(RM) $(ext_build_dir)/exts.mk
	$(Q)$(RMDIRS) $(@D)
