...
ext_build_dir = .bundle/gems/rbs-3.10.0

ruby = $(topdir:/=\)\miniruby.exe -I'$(topdir)' -I'$(top_srcdir)/lib' \
       -I'$(extout)/$(arch)' -I'$(extout)/common'
RUBY = $(ruby)
extensions = .bundle/gems/rbs-3.10.0/ext/rbs_extension/.
EXTOBJS = dmyext.obj
EXTLIBS =
EXTSO =
EXTLDFLAGS =
...
.bundle/gems/rbs-3.10.0/ext/rbs_extension/all:
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/rbs-3.10.0/ext/rbs_extension/install:
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/rbs-3.10.0/ext/rbs_extension/static:
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/rbs-3.10.0/ext/rbs_extension/install-so:
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/rbs-3.10.0/ext/rbs_extension/install-rb:
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/rbs-3.10.0/ext/rbs_extension/clean: clean-local
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
.bundle/gems/rbs-3.10.0/ext/rbs_extension/distclean: clean-local
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
	$(Q)$(RM) $(ext_build_dir)/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/rbs-3.10.0/ext/rbs_extension/realclean: clean-local
	$(Q)cd $(@D:/=\) && $(MAKE) $(MFLAGS) V=$(V) $(@F)
	$(Q)$(RM) $(ext_build_dir)/exts.mk
	$(Q)$(RMDIRS) $(@D)
