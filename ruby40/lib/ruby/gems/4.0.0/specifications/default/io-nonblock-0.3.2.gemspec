...
Gem::Specification.new do |s|
  ...
  s.files = ["COPYING".freeze, "README.md".freeze, "ext/io/nonblock/depend".freeze, "ext/io/nonblock/extconf.rb".freeze, "ext/io/nonblock/nonblock.c".freeze, "io/nonblock.so".freeze]
